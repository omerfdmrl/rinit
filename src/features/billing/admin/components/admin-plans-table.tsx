...
import { adminPlansColumns as columns } from './admin-plans-columns'
import { AdminPlansToolbar } from './admin-plans-toolbar'
...
export function AdminPlansTable({ search, navigate }: DataTableProps) {
